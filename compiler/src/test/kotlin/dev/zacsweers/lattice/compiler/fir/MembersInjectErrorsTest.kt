...
class MembersInjectErrorsTest : LatticeCompilerTest() {
  ...
  fun `injected properties in injected classes can move up - lateinit var`() {
    compile(
      ...
      assertDiagnostics(
        "w: ExampleClass.kt:8:24 Non-null injected member property in constructor-injected class should usually be moved to the inject constructor. If this has a default value, use Lattice's default values support."
      )
    }
  }
  ...
  fun `injected properties in injected classes can move up - primitive`() {
    compile(
      ...
      assertDiagnostics(
        "w: ExampleClass.kt:8:15 Non-null injected member property in constructor-injected class should usually be moved to the inject constructor. If this has a default value, use Lattice's default values support."
      )
    }
  }
